...
export default function RecButton() {
  ...
  return (
    <Button 
      variant={null}
      className={`h-full px-4 py-4 flex flex-1 flex-row justify-center items-center gap-2 hover:cursor-pointer transition-all duration-300 ease-in-out text-sm font-medium rounded-none ${
        isRecording 
